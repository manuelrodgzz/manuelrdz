...
const siteContent: SiteContentMap = {
    ...
    index: {
        ...
        aboutContent: {
            ...
            I graduated from the Universidad Autónoma de Nuevo León in 2021 with an IT bachelor degree but since I was in studying and until now I've been finding out and learning new programming languages and frameworks. That has allowed me to know new strategies to solve problems.`
        },
        technologiesTitle: {
            spanish: 'Tecnologías',
